...
AWS 기반 서비스 운영 환경에서 배포 표준화, 관측성 개선, 운영 자동화, 내부 플랫폼 고도화를 중심으로 일해왔습니다.
...
Workflow-driven platform improvement
Core Stack
Cloud & Platform
AWS
...
Bedrock을 활용해 운영 데이터, 문서, 로그, 이벤트 정보를 정리·분석하는 흐름을 검토하고 적용하며, AIOps 관점의 활용 가능성을 실무에 연결해왔습니다.
...
로그와 메트릭은 수집보다 실제 분석과 대응에 활용될 수 있도록 설계합니다.
...
내부 플랫폼 고도화 관련 기술 정리
<div align="center"> Profile README for <code>royalsaves</code> </div>
