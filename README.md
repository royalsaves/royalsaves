...
SM Entertainment 계열사 디어유(DearU)에서 유료 가입자 250만 규모의 프라이빗 메신저 서비스 **BUBBLE**의 AWS 인프라 전반을 단독으로 맡았습니다. 입사 당시 퍼블릭 인스턴스 기반 구조였던 걸 지금의 ECS 컨테이너 환경으로 바꾸는 일부터, 멀티 계정 5개를 관리하는 내부 콘솔 개발까지 혼자 설계하고 운영했습니다.
